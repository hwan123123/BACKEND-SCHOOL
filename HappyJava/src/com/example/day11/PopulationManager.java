...
public class PopulationManager {
    //알맞게 구현해 주세요.
    private Map<String, Integer> cityPopulationMap = new HashMap<>();
    ...
    public void removeCity(String city) {
        if (cityPopulationMap.containsKey(city)) {
            ...
            System.out.println(city + "는 존재하지 않는 도시입니다.");
        }
    }

    public void displayPopulation(String city) {
        if (cityPopulationMap.containsKey(city)) {
            System.out.println(city + "의 인구는 " + cityPopulationMap.get(city) + "명 입니다.");
        } else {
            System.out.println(city + "는 존재하지 않는 도시입니다.");
        }
    }
    ...
    public void displayAll() {
        System.out.println("전체 도시의 인구 정보:");
